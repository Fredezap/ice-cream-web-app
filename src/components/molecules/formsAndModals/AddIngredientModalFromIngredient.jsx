...
const AddIngredientModalFromIngredient = ({ showModalAddIngredient, setShowModalAddIngredient, handleSubmitAddIngredient}) => {
...
export default AddIngredientModalFromIngredient;